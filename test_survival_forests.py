...
def test_on(dataset, n_trees=50, n_trees_in_subset=5, max_features=2, max_depth=5, j_subspace=-1):
    train, test = dataset
    ...
    rf = RandomSurvivalForest(n_trees=n_trees,
                              ...
                              max_depth=max_depth,
                              random_J_subspace_size=j_subspace,disable_opt=True)
